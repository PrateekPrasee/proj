...
<body>
  ...
  <h1 style="text-align:left; position:relative;font-family:Lucida Handwriting;"><b>ARYABHATA</h1></b>
   ...
   <h5 style="font-size: 250%; margin-top: -28px">🙏</h5>
    ...
    <br><br><a href= "quiz.php" target="_blank" style="margin-left: 480px">DS Quiz</a>
     
    <br><br>
    </div>
      <div class="w3-container w3-left w3-animate-right">
    <a href= "quizcoa.php" target="_blank" style="margin-left: 480px">COA Quiz</a>
     
    <br><br>
     </div>
      <div class="w3-container w3-left w3-animate-left">
    <a href= "quizcss.php" target="_blank" style="margin-left: 480px; ">CSS Quiz</a>
    <br><br>
      </div>
